...
def main(args):
    ...
    if config.data.use_cdr123:
        Trainer = PairedCDR123pMHCCoembeddingTrainer(config, args.log_dir)
    else:
        Trainer = PairedCDR3pMHCCoembeddingTrainer(config, args.log_dir)
...
if __name__ == '__main__':
    ...
    '''
    python predict_tcr_pmhc_binding.py --config configs/config-paired-cdr3-pmhc-binding.yml \
    ...
    parser.add_argument('--config', type=str, default='config-paired-cdr3-pmhc-binding.yml')
