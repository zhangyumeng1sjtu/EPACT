...
def main(args):
    ...
    data_loader = DataLoader(
        ...
        collate_fn = UnlabeledBacthConverter(max_mhc_len = config.model.mhc_seq_len, paired_tcr=args.paired_tcr),
        shuffle = False
    )
    ...
    Trainer = EpitopeMHCTrainer(config, args.log_dir)
...
if __name__ == '__main__':
    ...
    '''
    python predict_pmhc_presentation.py --config configs/config-pmhc-binding.yml \
                                        --input_data_path <input_data_path> \
                                        --model_location checkpoints/pretrained/pmhc-model.pt \
                                        --log_dir <log_dir>
    '''
